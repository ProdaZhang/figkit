...
| **mail** (a real Figma capture) | ![mail screen rendered in HTML](docs/shots/mail-html.png) | ![mail screen rendered in Godot](docs/shots/mail-godot.png) |

The two Godot columns are the *same* `flow_binder.gd` reading the *same* `flow.json`.
